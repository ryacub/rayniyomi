...
class MangaExtensionsScreenModel(
    ...
    fun retryInstallUpdateExtension(extension: MangaExtension) {
        when (extension) {
            is MangaExtension.Available -> installExtension(extension)
            is MangaExtension.Installed -> if (extension.hasUpdate) updateExtension(extension)
            is MangaExtension.Untrusted -> Unit
        }
    }
    ...
    fun dismissInstallError(extension: MangaExtension) {
