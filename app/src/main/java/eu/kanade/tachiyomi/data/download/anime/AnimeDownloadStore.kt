...
class AnimeDownloadStore(
     ...
     */
    private val preferences = context.getSharedPreferences("active_downloads_anime", Context.MODE_PRIVATE)
    ...
    companion object {
        private const val KEY_MIGRATION_DONE = "anime_active_downloads_migrated"
    }
}
