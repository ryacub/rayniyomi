 ...
 */
class MangaExtensionManagerMapExtensionsTest {

    private val mapThreadName = "r913-map-worker"
    ...
    /**
     * A scope shaped like [MangaExtensionManager.scope]: a supervisor job over a
    ...
    private fun untrusted(pkgName: String): MangaExtension.Untrusted = MangaExtension.Untrusted(
        name = pkgName,
        pkgName = pkgName,
        versionName = "1.0",
        versionCode = 1,
