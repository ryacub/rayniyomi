...
- Codex merged PR changelog backfill:
- [#543](https://github.com/ryacub/rayniyomi/pull/543) - refactor: deterministic mpv font sync copy path (R530)
- [#542](https://github.com/ryacub/rayniyomi/pull/542) - refactor: migrate PlayerControls to collectAsStateWithLifecycle (R531)
- [#526](https://github.com/ryacub/rayniyomi/pull/526) - chore: test/tooling + unresolved dependency cleanup wave (R505)
- [#525](https://github.com/ryacub/rayniyomi/pull/525) - fix: harden one-off UI event delivery with buffered channels (R521)
- [#524](https://github.com/ryacub/rayniyomi/pull/524) - chore: Firebase and Google services alignment wave (R504)
- [#522](https://github.com/ryacub/rayniyomi/pull/522) - chore: Compose stack upgrade wave (R503)
- [#519](https://github.com/ryacub/rayniyomi/pull/519) - fix: migrate lifecycle-aware state collection in rayniyomi screens (R450)
- [#518](https://github.com/ryacub/rayniyomi/pull/518) - chore: AndroidX platform step-up wave (R502)
- [#517](https://github.com/ryacub/rayniyomi/pull/517) - refactor: migrate screen state collection to lifecycle-aware APIs (R451)
- [#516](https://github.com/ryacub/rayniyomi/pull/516) - chore: core runtime dependency upgrade wave (R501)
- [#510](https://github.com/ryacub/rayniyomi/pull/510) - feat: persist dialog/form state with rememberSaveable (R452)
- [#509](https://github.com/ryacub/rayniyomi/pull/509) - fix: avoid surfacing cancellation as UI errors (R445)
- [#508](https://github.com/ryacub/rayniyomi/pull/508) - chore: align Firebase config comments with runtime config (R497)
- [#501](https://github.com/ryacub/rayniyomi/pull/501) - fix: preserve Crashlytics build ID in release artifacts (R500)
- [#498](https://github.com/ryacub/rayniyomi/pull/498) - fix: move Crashlytics plugin application before android block (R495)
- [#491](https://github.com/ryacub/rayniyomi/pull/491) - fix: handle observer flow errors in entry enrichment screen (R445)
- [#490](https://github.com/ryacub/rayniyomi/pull/490) - ci: speed up workflows without reducing checks (R474)
- [#473](https://github.com/ryacub/rayniyomi/pull/473) - fix: remove unused sqldelight-android-paging dep (R470)
- [#433](https://github.com/ryacub/rayniyomi/pull/433) - fix: guard enrichment refresh timeout and clarify scoring constants (R414)
- [#432](https://github.com/ryacub/rayniyomi/pull/432) - feat: add discover recommendation feed and a11y groundwork (R417)
- [#431](https://github.com/ryacub/rayniyomi/pull/431) - feat: dynamic cover-based theming for entry views (R413)
- [#429](https://github.com/ryacub/rayniyomi/pull/429) - fix(enrichment): remove screen-model refresh race (R414)
- [#426](https://github.com/ryacub/rayniyomi/pull/426) - feat: add multi-tracker enrichment recommendations (R414)
- [#425](https://github.com/ryacub/rayniyomi/pull/425) - feat: add reactive light novel sources tab in Browse (R397)
- [#419](https://github.com/ryacub/rayniyomi/pull/419) - feat: bidirectional tracker sync with manual/auto triggers (R412)
- [#418](https://github.com/ryacub/rayniyomi/pull/418) - build: clean R8 missing-class warnings with targeted suppressions (R393)
- [#409](https://github.com/ryacub/rayniyomi/pull/409) - fix: make error-log write outcomes explicit with sealed result types (R387)
- [#408](https://github.com/ryacub/rayniyomi/pull/408) - chore: upgrade non-AGP/non-Kotlin Gradle plugins (R386)
- [#405](https://github.com/ryacub/rayniyomi/pull/405) - chore: bump target sdk to 35 (R384)
- [#404](https://github.com/ryacub/rayniyomi/pull/404) - fix: throttle light novel progress updates and improve a11y announcements (R403)
- [#402](https://github.com/ryacub/rayniyomi/pull/402) - feat: light novel transfer status + a11y hardening (R383)
- [#400](https://github.com/ryacub/rayniyomi/pull/400) - refactor: unify download status core for anime and manga (R382)
- [#398](https://github.com/ryacub/rayniyomi/pull/398) - fix: add manga download status transparency and low-storage recovery (R381)
- [#396](https://github.com/ryacub/rayniyomi/pull/396) - fix: add anime download status transparency and stall detection (R380)
- [#394](https://github.com/ryacub/rayniyomi/pull/394) - fix: avoid blocking sleep in tracker interceptors on HTTP 429 (R379)
- [#390](https://github.com/ryacub/rayniyomi/pull/390) - docs: backfill Unreleased changelog entries for merged PRs (R389)
- [#383](https://github.com/ryacub/rayniyomi/pull/383) - fix: guard error-log notification URIs on file creation failure (R378)
- [#382](https://github.com/ryacub/rayniyomi/pull/382) - chore: migrate context receivers to context parameters (R376)
- [#381](https://github.com/ryacub/rayniyomi/pull/381) - fix: migration chain fails when any migration fails (R377)
- [#327](https://github.com/ryacub/rayniyomi/pull/327) - perf: enable Gradle configuration cache and Kotlin daemon (R322)
- [#324](https://github.com/ryacub/rayniyomi/pull/324) - docs: prune README to simple bullet points (R323)
- [#312](https://github.com/ryacub/rayniyomi/pull/312) - ci: enforce plugin compatibility governance and matrix gates (R236)
- [#311](https://github.com/ryacub/rayniyomi/pull/311) - docs: add lean plugin compliance gate (R236)
- [#308](https://github.com/ryacub/rayniyomi/pull/308) - docs: add plugin security runbook with denylist support (R281)
- [#300](https://github.com/ryacub/rayniyomi/pull/300) - feat: light novel plugin backup/restore (R279)
- [#299](https://github.com/ryacub/rayniyomi/pull/299) - refactor: migrate light novel plugin UI to Jetpack Compose (R298)
- [#296](https://github.com/ryacub/rayniyomi/pull/296) - fix: harden light novel plugin MVP reliability paths (R278)
- [#295](https://github.com/ryacub/rayniyomi/pull/295) - feat: light novel plugin MVP APK module (R276)
- [#294](https://github.com/ryacub/rayniyomi/pull/294) - feat: add consent-first light novel plugin install flow (R274)
- [#293](https://github.com/ryacub/rayniyomi/pull/293) - feat: define plugin API compatibility handshake (R236)
- [#292](https://github.com/ryacub/rayniyomi/pull/292) - fix: harden light novel plugin verification and compatibility (R273)
- [#272](https://github.com/ryacub/rayniyomi/pull/272) - feat: add light novel gate and optional plugin install scaffold (R236)
- [#271](https://github.com/ryacub/rayniyomi/pull/271) - feat: improved categories with hierarchy and search (R242)
- [#270](https://github.com/ryacub/rayniyomi/pull/270) - feat: harden AniSkip intro/outro auto-skip and cache (R238)
- [#269](https://github.com/ryacub/rayniyomi/pull/269) - fix: canonical filtered selection mutations (R266)
- [#268](https://github.com/ryacub/rayniyomi/pull/268) - docs: document ReaderChapterListManager fetchChapters ANR context (R246)
- [#267](https://github.com/ryacub/rayniyomi/pull/267) - feat: add automatic webtoon auto-scroll reader (R241)
- [#265](https://github.com/ryacub/rayniyomi/pull/265) - refactor: extract shared entry ScreenModel helper composition (R137)
- [#263](https://github.com/ryacub/rayniyomi/pull/263) - test: expand ReaderChapterListManager coverage (R247)
- [#199](https://github.com/ryacub/rayniyomi/pull/199) - refactor: clean up player episode list state (R146)
- [#198](https://github.com/ryacub/rayniyomi/pull/198) - refactor: share download queue mutations (R14)
- [#197](https://github.com/ryacub/rayniyomi/pull/197) - perf: harden player loading for large lists (R61)
- [#196](https://github.com/ryacub/rayniyomi/pull/196) - refactor: harden global search request coordination (R123)
- [#195](https://github.com/ryacub/rayniyomi/pull/195) - fix: reconcile extension updates across repos/signatures (R54)
- [#179](https://github.com/ryacub/rayniyomi/pull/179) - feat: ship custom interval stable UX (R110)
- [#106](https://github.com/ryacub/rayniyomi/pull/106) - refactor: convert anime startDownloadNow to async-safe API (R05)
- [#103](https://github.com/ryacub/rayniyomi/pull/103) - refactor: convert MangaDownloadManager.startDownloadNow to async-safe API (R04)
- [#100](https://github.com/ryacub/rayniyomi/pull/100) - refactor: remove runBlocking from NotificationReceiver (R01)
- [#97](https://github.com/ryacub/rayniyomi/pull/97) - fix(reader): Use SSIV for tall images in long-strip mode (R55)
- [#96](https://github.com/ryacub/rayniyomi/pull/96) - docs: upstream sync and verification (R56)
- [#86](https://github.com/ryacub/rayniyomi/pull/86) - docs: enforce work-in-progress limits and branch ownership constraints (R44)
- [#84](https://github.com/ryacub/rayniyomi/pull/84) - docs: add fork compliance checklist to PR template (R39)
- [#82](https://github.com/ryacub/rayniyomi/pull/82) - docs: explicitly disable ACRA crash reporting for fork compliance (R38)
- [#81](https://github.com/ryacub/rayniyomi/pull/81) - docs: explicitly disable Firebase Analytics for fork compliance (R37)
- [#79](https://github.com/ryacub/rayniyomi/pull/79) - ci(r49): enforce issue-closing references in PR descriptions
- [#78](https://github.com/ryacub/rayniyomi/pull/78) - feat: change update checker to fork repo ryacub/rayniyomi (R36)
- [#77](https://github.com/ryacub/rayniyomi/pull/77) - feat: change base applicationId to xyz.rayniyomi (R35)
- [#76](https://github.com/ryacub/rayniyomi/pull/76) - chore(r34): [R34] update app display name and launcher icon assets
- [#74](https://github.com/ryacub/rayniyomi/pull/74) - docs: add GitHub issue linking to PR template for R33
- [#73](https://github.com/ryacub/rayniyomi/pull/73) - chore: add agent config files to .gitignore
- [#6](https://github.com/ryacub/rayniyomi/pull/6) - [R52] Run first agent smoke ticket and record validation
- [#2](https://github.com/ryacub/rayniyomi/pull/2) - [R50] Bootstrap governance workflows templates and CODEOWNERS
- [#1](https://github.com/ryacub/rayniyomi/pull/1) - fix: improve downloader efficiency and queue reliability
